...
const BrandLogo = () => (
  <svg viewBox="0 0 556.6 62.6" className="brand-logo" style={{ height: "24px", width: "auto" }}>
    ...
    <path fill="currentColor" d="M131.4,10.1l-8.7,9.1c-3.8-4.2-9.3-6.6-15-6.5c-4.9-0.1-9.6,1.8-13,5.3c-3.4,3.6-5.3,8.3-5.2,13.3c-0.1,4.9,1.7,9.7,5.2,13.3c3.4,3.5,8.1,5.4,13,5.3c5.7,0.1,11.2-2.3,15-6.5l8.7,9c-6,6.7-14.7,10.4-23.7,10.2c-9,0-16.7-2.9-22.9-8.9s-9.3-13.5-9.3-22.5s3-16.3,9.3-22.3s13.9-8.8,22.9-8.8C117.2,0.1,125,3.3,131.4,10.1z" />
    <path fill="currentColor" d="M139.9,62.6V0.1h14v10.5c2.8-6.2,9.3-10,17.6-10c1.4,0,2.8,0.1,4.2,0.4v13.6c-1.9-0.4-3.9-0.6-5.9-0.6c-9.8,0-16,6.1-16,15.9v32.8H139.9z" />
    <path fill="currentColor" d="M179.3,31.4c0-9.4,2.9-16.9,8.7-22.7s13.3-8.6,22.3-8.6c8.6,0,15.6,2.8,21,8.6s8.2,12.8,8.2,21.3c0,1.8-0.1,3.4-0.2,4.9h-46c0.5,9.4,7.4,15.5,17.9,15.5c2.9,0,5.9-0.6,8.6-1.7c5.2-2.3,11.3-1.3,15.4,2.6l0.5,0.5c-6.4,7-15.4,10.9-24.9,10.8c-9.3,0-16.9-3.1-22.7-8.6s-8.7-12.9-8.7-22.2V31.4z M225.2,25c0-3.5-1.7-6.8-4.5-9c-2.9-2.6-6.6-4-10.5-3.9c-4.1-0.1-8.1,1.3-11.4,3.8c-3,2.1-4.9,5.5-5.3,9.1H225.2z" />
    <path fill="currentColor" d="M294.9,10.4V0.1H309v62.5h-14.1V52.4c-2,5.8-9.2,10.2-18.9,10.2c-8,0-15.7-3.3-21.1-9.2c-5.6-6-8.5-13.3-8.5-22.1s2.8-16.1,8.5-22c5.5-5.8,13.2-9.1,21.2-8.9C285.8,0.5,292.9,4.6,294.9,10.4z M290.7,44.3c3.5-3.4,5.4-8.1,5.3-13c0.1-4.9-1.8-9.6-5.3-12.9c-3.4-3.4-8-5.3-12.8-5.2c-4.7-0.1-9.3,1.8-12.6,5.2c-3.3,3.5-5.1,8.1-4.9,12.9c-0.2,4.8,1.6,9.5,4.9,12.9c3.3,3.4,7.8,5.3,12.6,5.2C282.7,49.6,287.3,47.7,290.7,44.3L290.7,44.3z" />
    <path fill="currentColor" d="M321.2,62.6V0.1h14v10.5c2.8-6.2,9.3-10,17.6-10c1.4,0,2.8,0.1,4.2,0.4v13.6c-1.9-0.4-3.9-0.6-5.9-0.6c-9.8,0-16,6.1-16,15.9v32.8H321.2z" />
    <path fill="currentColor" d="M360.6,31.4c0-9.4,2.9-16.9,8.7-22.7s13.3-8.6,22.3-8.6c8.6,0,15.6,2.8,21,8.6s8.3,12.8,8.3,21.3c0,1.8-0.1,3.4-0.2,4.9h-46.1c0.5,9.4,7.4,15.5,17.9,15.5c2.9,0,5.8-0.6,8.5-1.7c5.2-2.3,11.3-1.3,15.4,2.6l0.5,0.5c-6.4,7-15.4,10.9-24.9,10.8c-9.3,0-16.9-3.1-22.7-8.6s-8.7-12.9-8.7-22.2L360.6,31.4z M406.6,25c0-3.5-1.7-6.8-4.5-9c-2.9-2.6-6.6-4-10.5-3.9c-4.1-0.1-8.1,1.3-11.4,3.8c-3,2.2-4.9,5.5-5.2,9.1H406.6z" />
    <path fill="currentColor" d="M430.3,62.6V0.1h14v10.1c2.8-5.8,9.5-9.6,18-9.6c14.1,0,22.4,9.1,22.4,23.7v38.3h-14.1V26.3c0-8.1-4.7-13.2-12.6-13.2s-13.8,5.6-13.8,13.7v35.7H430.3z" />
    <path fill="currentColor" d="M542.5,10.4V0.1h14.1v62.5h-14.1V52.4c-2,5.8-9.2,10.2-18.9,10.2c-8,0-15.7-3.3-21.1-9.2c-5.6-6-8.5-13.3-8.5-22.1s2.8-16.1,8.5-22c5.5-5.8,13.2-9.1,21.1-8.9C533.3,0.5,540.5,4.6,542.5,10.4z M538.3,44.3c3.5-3.4,5.4-8.1,5.3-12.9c0.1-4.9-1.8-9.6-5.3-12.9c-3.4-3.4-8-5.3-12.8-5.2c-4.7-0.1-9.3,1.8-12.6,5.2c-3.3,3.5-5.1,8.1-4.9,12.9c-0.2,4.8,1.6,9.5,4.9,12.9c3.3,3.4,7.8,5.3,12.6,5.2C530.3,49.6,534.9,47.7,538.3,44.3L538.3,44.3z" />
  </svg>
);
